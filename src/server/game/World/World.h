...
enum WorldIntConfigs : uint32
{
    ...
    CONFIG_NET_SPELL_RUPTURE,
    CONFIG_NET_SPELL_MASTER_POISONER,
    CONFIG_NET_SPELL_HEMORRHAGE,
    CONFIG_NET_SPELL_FAN_OF_KNIVES,
    CONFIG_NET_SPELL_GHOSTLY_STRIKE,
    CONFIG_NET_SPELL_MUTILATE,
    CONFIG_NET_SPELL_STEALTH_SPELL,
    CONFIG_NET_SPELL_VANISH,
    CONFIG_NET_SPELL_EVISCERATE,
    CONFIG_NET_SPELL_OVERKILL,
    CONFIG_NET_SPELL_OVERKILL_EFFECT,
    CONFIG_NET_SPELL_ENVENOM,
    CONFIG_NET_SPELL_DEADLY_POISON_EFFECT,
    CONFIG_NET_SPELL_ARCANE_BLAST,
    CONFIG_NET_SPELL_POLYMORPH,
    CONFIG_NET_SPELL_AMPLIFY_MAGIC,
    CONFIG_NET_SPELL_DAMPEN_MAGIC,
    CONFIG_NET_SPELL_ARCANE_MISSILES,
    CONFIG_NET_SPELL_MINOR_ARCANE_MISSILES,
    CONFIG_NET_SPELL_AGONY,
    CONFIG_NET_SPELL_MINOR_AGONY,
    CONFIG_NET_SPELL_DOOM,
    CONFIG_NET_SPELL_EXHAUSTION,
    // @net-end
